...
const servicesData: ServiceInfo[] = [
  ...
  },
  {
    ...
    discoverText: [
      ...
      "C’est idéal pour celles qui veut une pose unique, avec du caractère.",
    ],
    careTitle: "Préserver l’ongle",
    careText: [
    ...
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 md:py-20">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-3xl text-base leading-relaxed text-[var(--text-soft)]">
          Découvrez chaque prestation à travers une image, une explication simple et des conseils
          pour mieux préserver l’ongle.
        </p>
      </div>
              ...
              <div className="mt-5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm font-medium text-[var(--gold-deep)]">
